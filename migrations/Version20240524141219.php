 ...
 */
final class Version20240524141219 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD login VARCHAR(20) NOT NULL, DROP pseudo, CHANGE mdp password VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, contenu VARCHAR(500) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_general_ci`, dateCreation DATE NOT NULL, idChat INT NOT NULL, idAuteur INT NOT NULL, idDestinataire INT NOT NULL, INDEX idChat (idChat), INDEX idDestinataire (idDestinataire), INDEX idAuteur (idAuteur), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE typeannonce CHANGE libelle libelle VARCHAR(20) DEFAULT NULL');
        $this->addSql('ALTER TABLE typeequide CHANGE libelle libelle VARCHAR(20) DEFAULT NULL');
        $this->addSql('ALTER TABLE utilisateur ADD pseudo VARCHAR(20) DEFAULT \'NULL\', DROP login, CHANGE password mdp VARCHAR(255) NOT NULL');
    }
}

 ...
 */
final class Version20230921094648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonce CHANGE description description VARCHAR(1000) DEFAULT \'NULL\', CHANGE activation activation TINYINT(1) DEFAULT true, CHANGE dateCreation dateCreation DATE DEFAULT \'CURRENT_TIMESTAMP\', CHANGE idUtilisateurAnnonce idUtilisateurAnnonce INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_AE76D40C9EAA7E4 ON equide (robe)');
        $this->addSql('DROP INDEX fk_equiderace ON equide');
        $this->addSql('CREATE INDEX IDX_AE76D40DA6FBBAF ON equide (race)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonce CHANGE description description VARCHAR(1000) DEFAULT NULL, CHANGE activation activation TINYINT(1) DEFAULT NULL, CHANGE dateCreation dateCreation DATE DEFAULT NULL, CHANGE idUtilisateurAnnonce idUtilisateurAnnonce INT NOT NULL');
        ...
        $this->addSql('DROP INDEX idx_ae76d40da6fbbaf ON equide');
        $this->addSql('CREATE INDEX FK_EquideRace ON equide (race)');
        $this->addSql('DROP INDEX idx_ae76d40c9eaa7e4 ON equide');
        $this->addSql('CREATE INDEX FK_EquideRobe ON equide (robe)');
        $this->addSql('ALTER TABLE equide ADD CONSTRAINT FK_AE76D40C9EAA7E4 FOREIGN KEY (robe) REFERENCES robe (id)');
        $this->addSql('ALTER TABLE equide ADD CONSTRAINT FK_AE76D40DA6FBBAF FOREIGN KEY (race) REFERENCES race (id)');
        $this->addSql('ALTER TABLE favoris CHANGE dateCreation dateCreation DATE DEFAULT NULL');
